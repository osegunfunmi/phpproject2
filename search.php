...
if(isset($_POST['sub']))
{
 ...
 $sql = mysql_query("SELECT * FROM networking WHERE id='$getId'");
...
<div style="color:red;margin-left:16px;"><b><?php echo $err; ?></b></div>   
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" name="search" placeholder="Enter ID" value="<?php echo empty($_POST['search'])? "":$_POST['search']; ?>">
                </div>
              </div>
              <!-- /.box-body -->
...
<div class="col-md-6">
		...
		<table  class="table table-bordered">
			...
			<tr>
				<td colspan="2"><a href="getnetwork.php?nhblie=<?php echo $row['id']; ?>">View</a> | <a href="editprofile.php?id=<?php echo $row['id']; ?>">Edit</a>| <a href="cdownliners.php?pid=<?php echo $row['id']; ?>">Add Downliner</a></td>
			</tr>
